...
$dados=("insert into  usuarios(nome, sobrenome,usuario, senha,dia,mes,ano,estado,cidade,meta) values ('$nome','$sobrenome','$usuario','$gravaSenha','$dia','$mes','$ano','$estado','$cidade','$saida')");
