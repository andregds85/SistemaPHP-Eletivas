...
// executa a consulta
$sql = "SELECT * FROM hospitalar_usuarios";
...
$dados=("insert into hospitalar_usuarios(nome, sobrenome,email, senha) values ('$nome','$sobrenome','$usuario','$gravaSenha')");
