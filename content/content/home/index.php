...
<div class="card">
  <div class="card-header">
    Módulo (Hospitalar / SC)
  </div>
  <div class="card-body">
    <h5 class="card-title">Login - Autenticação - Hospitalar / SC</h5>
    <p class="card-text">Módulo de Login (Hospitalar / SC). Para acessar o sistema basta se autenticar aqui</p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="TituloModalCentralizado">Login - Autenticação - Hospitalar / sc</h5>
    ...
    <form class="form-inline my-2 my-lg-0"  method="post" action="hospitalar/main/valida_usuario.php">
